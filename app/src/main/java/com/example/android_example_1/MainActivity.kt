package com.example.android_example_1

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import com.example.android_example_1.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkAnswer() {
        ...
        if (answer.toLowerCase() == getString(R.string.giraffe).toLowerCase()) {
